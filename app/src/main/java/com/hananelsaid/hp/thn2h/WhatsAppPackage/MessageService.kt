package com.hananelsaid.hp.thn2h.WhatsAppPackage
...
//        }
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent) {
        ...
        Log.i(TAG, "onAccessibilityEvent " + nodeInfo!!.viewIdResourceName)
        Log.i(TAG, "")
                ...
                if (event.eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED|| event.eventType == AccessibilityEvent.TYPE_VIEW_FOCUSED || true) {
                    ...
                    if (entryETNodes.size == 1) {
                        ...
                        arguments.putCharSequence(
                            AccessibilityNodeInfo.ACTION_ARGUMENT_SET_TEXT_CHARSEQUENCE, sMsg
                        )
                    ...
                    if (nodeInfo.viewIdResourceName == null) {
                        ...
                        if (sendBtnNodes.size == 1) {
                            val entryETNodes =
                                nodeInfo.findAccessibilityNodeInfosByViewId("com.whatsapp:id/entry")
    ...
    companion object {
        ...
        var myInstance: MessageService? = null
        var sContext: Context?=null
        fun getMInstance(): MessageService?{
            return myInstance
        }
    }}